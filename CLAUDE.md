...
## Aktuelle Phase
**Phase 3 abgeschlossen (GO erteilt) → als Nächstes Phase 4 (Persistenz, Auth & erste echte Testteilnehmer)** (SPEC.md Abschnitt 13). Leitplanken für Phase 4: `DECISIONS.md` D3.1–D3.3. Diese Zeile beim Phasenwechsel aktualisieren.
